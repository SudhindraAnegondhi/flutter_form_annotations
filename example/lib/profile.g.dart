...
// **************************************************************************
// Generator: FieldCheckboxBuilder
// **************************************************************************

Widget checkBoxFormField(BuildContext context, Map<String, dynamic> _formData,
  ...
  return Checkbox(
    ...
    splashRadius: null,
    tristate: false,
    value: _formData['checkBox'] ?? false,
    onChanged: (bool? value) {
      onSaved('checkBox', value, parent: '');
    },
  );
}
...
Widget carTypeFormField(BuildContext context, Map<String, dynamic> _formData,
    {required Function onSaved, required double width}) {
  var _selectedValue = _formData['carType'];
  return Wrap(
      children: CarType.values.map((value) {
    return ChoiceChip(
      autofocus: false,
      avatar: null,
...
Widget salaryRangeFormField(
  ...
  double? start =
      double.tryParse(_formData['salaryRange']?.split(',').first ?? "40000.0");
  double? end =
      double.tryParse(_formData['salaryRange']?.split(',').last ?? "80000.0");
                      ...
                      Expanded(
                        child: ListView(
                          ...
                          children: <Widget>[
                            ...
                            checkBoxFormField(context, _formData,
                                onSaved: onSaved, width: _width),
                            carTypeFormField(context, _formData,
                                onSaved: onSaved, width: _width),
